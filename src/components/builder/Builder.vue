<template>
    <div class="flex font-minecraft bg-mc-bg min-h-screen">
        ...
        <div class="md:p-8 p-4 w-full">
            ...
            <AbilityTree :connectors="WARRIOR_CONNECTORS" :tree="WARRIOR_ABILITY_TREE"/>
        </div>
    </div>
</template>
...
export default {
    ...
    setup() {
        ...
        return { router, helmet, chestplate, leggings, boots, ring1, ring2, bracelet, necklace, weapon, WARRIOR_ABILITY_TREE, ARCHER_ABILITY_TREE, WARRIOR_CONNECTORS, abilityTree, treeConnectors, handleWeaponChanged}
    },
